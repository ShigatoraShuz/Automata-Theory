...
export const alphaDFA: DFADefinition = {
  ...
  states: [
    { id: 's0', label: 's0', x: 90,  y: 280, isStart: true,  isAccept: false },
    { id: 's2', label: 's2', x: 250, y: 150, isStart: false, isAccept: false },
    { id: 's1', label: 's1', x: 250, y: 410, isStart: false, isAccept: false },
    { id: 's4', label: 's4', x: 430, y: 150, isStart: false, isAccept: false },
    { id: 's3', label: 's3', x: 430, y: 410, isStart: false, isAccept: false },
    { id: 'T',  label: 'T',  x: 430, y: 280, isStart: false, isAccept: false, isTrap: true },
    { id: 's5', label: 's5', x: 620, y: 280, isStart: false, isAccept: false },
    { id: 's6', label: 's6', x: 790, y: 165, isStart: false, isAccept: false },
    { id: 's7', label: 's7', x: 950, y: 280, isStart: false, isAccept: false },
    { id: 's8', label: 's8', x: 790, y: 410, isStart: false, isAccept: false },
    { id: 's9', label: 's9', x: 1010, y: 410, isStart: false, isAccept: true },
  ],
  transitions: [
    { from: 's0', to: 's2', label: 'a', curve: 'curve-up', labelOffset: { x: -18, y: -18 } },
    { from: 's0', to: 's1', label: 'b', curve: 'curve-down',   labelOffset: { x: -18, y: 18 } },
    { from: 's2', to: 's4', label: 'b', curve: 'straight',   labelOffset: { x: 0, y: -18 } },
    { from: 's2', to: 'T',  label: 'a', curve: 'curve-down', labelOffset: { x: -22, y: -4 } },
    { from: 's4', to: 's5', label: 'a', curve: 'curve-down',   labelOffset: { x: 0, y: -16 } },
    { from: 's4', to: 'T',  label: 'b', curve: 'curve-down',   labelOffset: { x: 18, y: -2 } },
    { from: 's1', to: 's3', label: 'a', curve: 'straight',   labelOffset: { x: 0, y: 18 } },
    { from: 's1', to: 'T',  label: 'b', curve: 'curve-up', labelOffset: { x: -22, y: 4 } },
    { from: 's3', to: 's5', label: 'b', curve: 'curve-up',   labelOffset: { x: 0, y: 16 } },
    { from: 's3', to: 'T',  label: 'a', curve: 'curve-up', labelOffset: { x: 18, y: 2 } },
    { from: 'T',  to: 'T',  label: 'a,b', curve: 'self-loop-left', labelOffset: { x: -42, y: 0 } },
    { from: 's5', to: 's5', label: 'a', curve: 'self-loop-top', labelOffset: { x: 0, y: -28 } },
    { from: 's5', to: 's6', label: 'b', curve: 'curve-up',   labelOffset: { x: -8, y: -18 } },
    { from: 's6', to: 's6', label: 'b', curve: 'self-loop-top', labelOffset: { x: 0, y: -28 } },
    { from: 's6', to: 's7', label: 'a', curve: 'curve-up',   labelOffset: { x: 8, y: -18 } },
    { from: 's7', to: 's5', label: 'a', curve: 'curve-up',   labelOffset: { x: 0, y: -24 } },
    { from: 's7', to: 's8', label: 'b', curve: 'curve-down', labelOffset: { x: 18, y: 4 } },
    { from: 's8', to: 's9', label: 'a,b', curve: 'straight', labelOffset: { x: 0, y: 20 } },
    { from: 's9', to: 's9', label: 'a,b', curve: 'self-loop-right', labelOffset: { x: 42, y: 0 } },
  ],
  transitionTable: {
    s0: { a: 's2', b: 's1' },
    s1: { a: 's3', b: 'T'  },
